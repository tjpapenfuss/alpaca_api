...
from strategies.tax_loss_harvesting import track_and_manage_positions
from utils.allocation import invest_available_cash
...
class InvestmentForecastingModel:
    ...
    def run_simulation(self):
        ...
        for i, investment_date in enumerate(self.investment_dates):
            ...
            transactions, sold_tickers = track_and_manage_positions(self.portfolio, prices, \
            ...
            transactions = invest_available_cash(self.portfolio, allocation_weights, prices, \
            ...
            transactions = check_and_rebalance(portfolio=self.portfolio, prices=prices, investment_date=investment_date, \
